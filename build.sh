...
cc -o aetherc -Wall -Wextra -Ilibs/aether/ir-src -Ilibs -Ilibs/aether/vm-include \
  -Ilibs/aether/ir-include -z execstack "${@:1}" $AETHER_COMPILER_SRC \
  $AETHER_IR_SRC $LEXGEN_SRC
